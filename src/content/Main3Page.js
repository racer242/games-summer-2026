    ...
    return (
      <div className="mainPage common g3">
        ...
        <div className="plate appear-top delay500ms">
          ...
          <p>
            Натапай банку как можно больше раз за отведенное время, за
            каждые&nbsp;
            {this.state.game3.tapBonusCount} тапов получай +
            {this.state.game3.bonusValue} очков. Также тапай дополнительные
            предметы и получай +{this.state.game3.objectBonusValue} очка за
            каждый.
            <br />
            <br />
            Время игры – {this.state.game3.gameDuration}&nbsp;секунд.
          </p>
        </div>
        <div
